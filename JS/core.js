...
class Entry{
    constructor(name,vehicleName,vehicleNo,entryDate,exitDate){
        this.name = name;
...
class UI{
    ...
    static validateInputs(){
        ...
        if(this.name === '' || vehicleName === '' || vehicleNo === '' || entryDate === '' || exitDate === ''){
...
//Event Add
    document.querySelector('#entryForm').addEventListener('submit',(e)=>{
        ...
        const car = document.querySelector('#vehicleName').value;
        const licensePlate = document.querySelector('#vehicleNo').value;
        const entryDate = document.querySelector('#entryDate').value;
        const exitDate = document.querySelector('#exitDate').value;
        ...
        //Instatiate Entry
        const entry = new Entry(name, vehicleName, vehicleNo, entryDate, exitDate);
...
//Event Remove
    document.querySelector('#tableBody').addEventListener('click',(e)=>{
        ...
        var vehicleNo = e.target.parentElement.previousElementSibling.previousElementSibling.previousElementSibling.textContent;
        //Call to Store function to remove entry from the local storage
        Store.removeEntries(vehicleNo);
